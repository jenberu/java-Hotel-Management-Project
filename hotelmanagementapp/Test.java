...
GridPane root = new GridPane();
        ...
        fp.getChildren().addAll(addbtn, clearbtn);
        root.add(fp, 1, 10);
        BorderPane bpane= new BorderPane();



        ImageView backbtn=new ImageView("hotelmanagementapp/download.png");
        backbtn.setFitWidth(50);
        backbtn.setFitHeight(50);
        ...
        primaryStage.setTitle(" Add Staff  page");
        ...
        AdimiPage getadminPage=new AdimiPage();
        getadminPage.getAdimiPage(primaryStage);
